...
public class FacilityOwnerDtoValidator:AbstractValidator<FacilityOwnerDTO>
{
    public FacilityOwnerDtoValidator()
    {
        RuleFor(x => x.Email)
        ...
        RuleFor(x => x.FacilitiesLocation)
            .NotEmpty().WithMessage("location is required");

        RuleFor(x => x.FacilitiesNumber)
            .GreaterThan(0).WithMessage("Number of facilities must be greater than 0.");
    }
}
